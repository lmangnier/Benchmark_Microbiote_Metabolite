...
#Beta= [-0.5,-0.25,0.25,0.5], 25/25 microbiotes-metabolites
#1000 replicates are generated under each scenario
set.seed(123456)

list.scenarios.dense.Microbiotes = list()
list.scenarios.dense.Metabolites = list()
list.scenarios.dense.index = list()
...
for(m in c(1,3,10)){
  ...
  for(beta in c(-0.5, -0.25, 0.25, 0.5)){
    ...
    list.scenarios.dense.index[[paste0("Scenario_",m,"_beta_",beta)]] = list.index
    list.scenarios.dense.Microbiotes[[paste0("Scenario_",m,"_beta_",beta)]] = list.microbiotes
    list.scenarios.dense.Metabolites[[paste0("Scenario_",m,"_beta_",beta)]] = list.metabolites
  }
  
}


saveRDS(list.scenarios.dense.index, "C:\\Users\\loicm\\Desktop\\Projets\\Mimint\\data\\data_scenarios_denses_fixed_index.RDS")
saveRDS(list.scenarios.dense.Microbiotes, "C:\\Users\\loicm\\Desktop\\Projets\\Mimint\\data\\data_scenarios_denses_fixed_Microbiotes.RDS")
saveRDS(list.scenarios.dense.Metabolites, "C:\\Users\\loicm\\Desktop\\Projets\\Mimint\\data\\data_scenarios_denses_fixed_Metabolites.RDS")
